...
#当仓位为1时，买入上涨指数，当仓位为0时，空城。 计算从19920101至今的资金在指数
...
year_rtn = index_data.set_index('date')[['change', '海龟法则每日涨跌幅']].resample('A', how=lambda x: ( x + 1.0).prod() - 1.0) * 100
print year_rtn